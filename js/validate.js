$(document).ready(function(){
	...
	// 	return this.optional(element) || /^[a-zA-ZñÑ\s]{2,20}+$/.test(value);
	...
	// 	return this.optional(element) || /^[a-zA-ZñÑ][\w]{2,20}+$/.test(value);
	...
	// 	return this.optional(element) || /^[a-zñÑ]+[\w-\.]{2,}@([\w-]{2,}\.)+[\w-]{2,4}$/.test(value);
