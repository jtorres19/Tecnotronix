...
<!----------------------- Datos de perfil-deportista, formulario de actalizacion--------------->
 			<form method="POST">
				...
				<div class="custom-control custom-radio">
					<input type="radio" id="customRadio1" name="customRadio" class="custom-control-input" tabindex="6">
				  	<label class="custom-control-label" for="customRadio1">Femenino</label>
				</div>
				<div class="custom-control custom-radio">
					<input type="radio" id="customRadio2" name="customRadio" class="custom-control-input" tabindex="7">
